//This is a Random Quote Machine built using HTML, CSS AND JavaScript. This project foloowes the FreeCoseCamp guide for he project the guide is as foloowes:
